...
//		    while (rs.next()) {
//			System.out.format("%d, '%s', '%s', '%s', '%s', '%s', '%s', '%s'%n", rs.getInt("BEINGID"),
//				rs.getString("LASTNAME"), rs.getString("FIRSTNAME"), rs.getString("BIRTHDATE"),
//				rs.getString("BIRTHPLACE"), rs.getString("DEATHDATE"), rs.getString("DEATHPLACE"),
//				rs.getString("BEINGCLASS"));
			
			while (rs.next()) {
				System.out.format("%d, '%s', '%s', '%s', '%s', '%s'%n", rs.getInt("JediID"),
					rs.getString("JediLastName"), rs.getString("JediRank"), rs.getString("JediSpecialization"),
					rs.getString("SaberType"), rs.getString("SaberColor"));
		    }
		}
